...
| **DOS** | x86 (8086/8088) | nasm | [docs/dos.md](docs/dos.md) |
...
The tool auto-detects the system from file extensions (`.nes`, `.ch8`, `.rom`, `.com`):
...
* **[DOS Disassembly Guide](docs/dos.md)** - DOS-specific features and usage
...
Optional: assembler tools for reassembly (ca65, asm6f, nesasm, retroasm, nasm) and verification (ca65, asm6f, nesasm).
